...
# To get an interactive dashboard in Dash
# do:
...
app.layout = html.Div(children=[ html.H1('Flight Delay Time Statics Dashboard', 
...
def get_graph(entered_year):
    ...
    late_fig = px.line(avg_car, x='Month', y='AircraftDelay', color='Reporting_Airline', title='Average aircraft delay time (minutes) by airline')
